...
//        });
    ...
    public static void doStepView(Context tContext) {
        ...
        try {
            Log.i(LOG_TAG, " RecipeActivity mGridview.getCount before " + rGridview.getCount());
            rGridview.setAdapter(RecipeActivity.rAdapter);
            Log.i(LOG_TAG, " RecipeActivity mGridview.getCount after " + rGridview.getCount());
        } catch (Exception e) {
            Log.i(LOG_TAG, "Exception  RecipeActivity.mGridview.setAdapter(RecipeActivity.mAdapter) = " + e.toString());
        }

        rAdapter.notifyDataSetChanged();
        Log.i(LOG_TAG, "RecipeActivity  doGridView before return   mAdapter.getCount=" + rAdapter.getCount());
        Log.i(LOG_TAG, " RecipeActivity doGridView before return   mGridview.getCount=" + rGridview.getCount());
    ...
    public static void doIngredientView(Context tContext) {
        ...
        Log.i(LOG_TAG, "RecipeActivity doIngredientView");
